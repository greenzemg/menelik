...
<section>
	...
	<div class="row">
		<div class="col-lg-4">
			...
			<address>
				<strong>RealPower Pty Ltd</strong><br>
				Bole Street, Addis Abeba<br>
				Mega Building Off.N 510<br>
				<abbr title="Phone">P: </abbr> +251 31729242
			</address>
		</div>
		<div class="col-lg-8">
			<form action="#" class="form-horizontal" role="form">
				...
				<div class="form-group">
					<div class="col-lg-10 col-lg-offset-2">
						<button type="submit" class="btn btn-primary">Send Message fuck</button>
					</div>
				</div>
			</form>
		</div>
